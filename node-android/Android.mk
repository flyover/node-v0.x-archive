...
#NODE_SRC_FILES += $(NODE_PATH)/src/node_counters.cc
NODE_SRC_FILES += $(NODE_PATH)/src/node_crypto.cc
#NODE_SRC_FILES += $(NODE_PATH)/src/node_dtrace.cc
...
#NODE_SRC_FILES += $(NODE_PATH)/src/node_main.cc
...
#NODE_SRC_FILES += $(NODE_PATH)/src/node_win32_etw_provider.cc
#NODE_SRC_FILES += $(NODE_PATH)/src/node_win32_perfctr_provider.cc
...
#CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/contrib/minizip/iowin32.c
#CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/contrib/minizip/miniunz.c
#CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/contrib/minizip/minizip.c
#CHROME_ZLIB_SRC_FILES += $(NODE_PATH)/deps/zlib/contrib/minizip/mztools.c
...
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/aix.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/async.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/core.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/cygwin.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/darwin.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/dl.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/error.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/freebsd.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/fs.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/fsevents.c
UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/getaddrinfo.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/kqueue.c
...
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/netbsd.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/openbsd.c
...
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/unix/sunos.c
...
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/async.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/core.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/dl.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/error.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/fs-event.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/fs.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/getaddrinfo.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/handle.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/loop-watcher.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/pipe.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/poll.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/process-stdio.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/process.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/req.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/signal.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/stream.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/tcp.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/thread.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/threadpool.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/timer.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/tty.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/udp.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/util.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/winapi.c
#UV_SRC_FILES += $(NODE_PATH)/deps/uv/src/win/winsock.c
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-cygwin.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-freebsd.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-linux.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-macos.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-nullos.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-openbsd.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-posix.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-solaris.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/platform-win32.cc
V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/preparse-data.cc
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/preparser-api.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/v8preparserdll-main.cc
...
#V8_BASE_SRC_FILES += $(NODE_PATH)/deps/v8/src/win32-math.cc
